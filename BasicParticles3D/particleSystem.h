...
private:
	// one uniform buffer can be 65 kilobytes large
	// each particle is 4 * 16 bytes large,
	// so we can fit 1024 particles in each buffer
	// we can add more buffers for more particles
